...
namespace Elasticsearch.Net7.Specification.IngestApi
{
	...
	public partial class LowLevelIngestNamespace : NamespacedClientProxy
	{
		...
		public TResponse GeoIpStats<TResponse>(GeoIpStatsRequestParameters requestParameters = null)
			where TResponse : class, IElasticsearchResponse, new() => DoRequest<TResponse>(GET, "_ingest/geoip/stats", null, RequestParams(requestParameters));
		///<summary>GET on /_ingest/geoip/stats <para>https://www.elastic.co/guide/en/elasticsearch/reference/master/geoip-stats-api.html</para></summary>
		///<param name = "requestParameters">Request specific configuration such as querystring parameters &amp; request specific connection settings.</param>
		...
		public Task<TResponse> GeoIpStatsAsync<TResponse>(GeoIpStatsRequestParameters requestParameters = null, CancellationToken ctx = default)
			where TResponse : class, IElasticsearchResponse, new() => DoRequestAsync<TResponse>(GET, "_ingest/geoip/stats", ctx, null, RequestParams(requestParameters));

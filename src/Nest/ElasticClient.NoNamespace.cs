...
using Nest7;
using Nest7.Specification.AsyncSearchApi;
using Nest7.Specification.CatApi;
using Nest7.Specification.ClusterApi;
using Nest7.Specification.CrossClusterReplicationApi;
using Nest7.Specification.DanglingIndicesApi;
using Nest7.Specification.EnrichApi;
using Nest7.Specification.EqlApi;
using Nest7.Specification.GraphApi;
using Nest7.Specification.IndexLifecycleManagementApi;
using Nest7.Specification.IndicesApi;
using Nest7.Specification.IngestApi;
using Nest7.Specification.LicenseApi;
using Nest7.Specification.MachineLearningApi;
using Nest7.Specification.MigrationApi;
using Nest7.Specification.NodesApi;
using Nest7.Specification.RollupApi;
using Nest7.Specification.SecurityApi;
using Nest7.Specification.SnapshotApi;
using Nest7.Specification.SnapshotLifecycleManagementApi;
using Nest7.Specification.SqlApi;
using Nest7.Specification.TasksApi;
using Nest7.Specification.TransformApi;
using Nest7.Specification.WatcherApi;
using Nest7.Specification.XPackApi;

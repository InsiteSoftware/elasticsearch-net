...
namespace Nest7
{
	...
	public partial class PropertiesDescriptor<T> where T : class
	{
		...
		/// <inheritdoc cref="IDenseVectorProperty" />
		public PropertiesDescriptor<T> DenseVector(Func<DenseVectorPropertyDescriptor<T>, IDenseVectorProperty> selector) => SetProperty(selector);
		...
		/// <inheritdoc cref="ISearchAsYouTypeProperty" />
		public PropertiesDescriptor<T> SearchAsYouType(Func<SearchAsYouTypePropertyDescriptor<T>, ISearchAsYouTypeProperty> selector) =>
			SetProperty(selector);
